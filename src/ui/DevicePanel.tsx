import { Bluetooth, Usb, LogOut, RotateCcw } from "lucide-react";
...
export const DevicePanel = ({
    ...
    return (
        <div className="p-4 pb-0">
            <div className="w-full flex items-center justify-between p-4 pl-5 rounded-[20px] bg-primary/10 shadow-sm">
